...
In this project we are focusing on the missing persons data for the United States. Our data is derived from NamUS' public data software.
This missing persons' data is specifically for the United States. In this data we explore the number of people that are missing in the U. S, their ages, race/ethnicity, states, and counties. 
The reason we chose to look at this data is because there is a growing number of missing persons in America by the year, and we feel that it is an issue that deserves 
more attention (not only from the media but also from authorities). In fact, Statista.com report that, as of 2018, over 600,000 people are recorded missing yearly.
A missing person can be defined as a person who may go missing due to an accident, death in a location where the body cannot be found, crime, a voluntary disappearance, or
for other reasons unknown to the public. The reasons for going lost are numerous and shifted and can incorporate mental illness, accidents, household violence, and being a casualty of crime. 
While there are risks linked to any particular missing persons case, specific population groups are perceived as especially at risk of becoming lost or missing. 
Grown-ups are more likely to be recorded as long-term lost people, in any case, and youth are most likely to be detailed lost at a rate of 6 times the national average. 
Thus, the most widely known, at risk groups of becoming  lost within our communities include children and teens, young adults, those enduring a mental illness or depression,
the elderly, those living with dementia, people communicating self-destructive thoughts, those living with mental or physical incapacity and who have no access to life saving 
medications. As these groups are understood to be at risk, for plausible reasons, our project aims to look at the data for missing persons in America under three distinct scopes, 
1. age & gender, 2. race/ethnicity, and 3. geographical location. In doing so, we hope to observe additional trends within those people who have gone missing between 1902 and 2018,
to compile a form of risk self-assessment for the viewer to utilize in answering the question: How at risk am I of becoming a missing person?
---
...
- Our main tool set for this project were dplyr tools as well as the packages of Lubridate,tidyverse, ggplot2 and GridExtra. We utilized filter a lot throughout our analysis, since a big chunk of our work dealt with sifting our data through specific scopes in order to see how these changed our outputs. 
